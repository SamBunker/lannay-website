...
function getTypeClass(type) {
  ...
  if (t.includes('startup') || t.includes('consultation')) return 'startup';
  if (t.includes('nonprofit') || t.includes('non-profit') || t.includes('community') || t.includes('outreach')) return 'nonprofit';
  if (t.includes('imc') || t.includes('integrated') || t.includes('analysis')) return 'imc';
  if (t.includes('brand') || t.includes('identity')) return 'brand';
  if (t.includes('design') || t.includes('print') || t.includes('digital') || t.includes('multimedia')) return 'design';
  if (t.includes('director') || t.includes('president') || t.includes('staff') || t.includes('marketing')) return 'leadership';
  return 'default';
}
                ...
                {cat.items.map(item => (
                  ...
                  >
                    <div className="portfolio__card-inner">
                      <div className={`portfolio__card-type portfolio__card-type--${getTypeClass(item.type)}`}>{item.type}</div>
